...
#   included: "Invitations; rules; detailed character notes for 17 different roles, including backstory, goals, and specific knowledge about other characters; printable paper props; decorating and site layout suggestions; detailed instructions for hosts; prop list",
#   not_included: "Most physical materials, including character props",
#   difficulty: "Medium",
#   notes: "The hosts of The Silver of Burnt Grass should expect to spend at least a couple hours tracking down the appropriate props. Some, but not all, of this responsibility can be passed on to the players. The Silver of Burnt Grass uses an optional dueling mechanic that improves the game, but requires a fair amount of set-up. Little to no decoration is required, but the game is better in a suitably decorated space.",
#   price: 100,
#   player_min: 16,
#   player_max: 20,
#   play_time: 3,
...
#   notes: "Our Lady of Interplanetary Ascendance works best in a strange and immersive setting. Hosts should expect to do substantial redecorating. The hosts have roles in the game, as well, which ideally involve a small amount of memorization.",
#   price: 100,
#   player_min: 16,
#   player_max: 20,
#   play_time: 3,
...
#   included: "Invitations; rules; detailed character notes for 22 different roles, including backstory, goals, and specific knowledge about other characters; printable paper props; decorating and site layout suggestions; detailed instructions for hosts; prop list",
#   not_included: "Most physical materials, including character props",
...
#   included: "Invitations; rules; detailed character notes for 25 different roles, including backstory, goals, and specific knowledge about other characters; printable paper props; decorating and site layout suggestions; detailed instructions for hosts; prop list",
#   not_included: "Most physical materials, including character props",
#   difficulty: "Medium",
